<template>
  <button
    @click="$emit('click')"
    class="sidebar-item w-full flex items-center justify-between px-3 py-2 text-sm font-medium rounded-lg transition-colors"
    :class="{
      'bg-blue-600 text-white': active,
      'text-gray-300 hover:text-white hover:bg-gray-800': !active
    }"
  >
...
// Mapeamento de ícones para componentes SVG
